  ...
  <div v-else class="app-layout">
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        ...
        <div class="nav-section" v-if="settings.isTabVisible('items') || settings.isTabVisible('inventory_transfers') || settings.isTabVisible('write_offs') || settings.isTabVisible('production') || true">
          ...
          <router-link to="/inventory/stock-balance" class="nav-item" active-class="active">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            <span v-if="!sidebarCollapsed">Stock Balance</span>
          </router-link>
        </div>
        ...
        <div class="nav-section">
          ...
          <router-link to="/import" class="nav-item" active-class="active">
            ...
            <span v-if="!sidebarCollapsed">Import</span>
          </router-link>
